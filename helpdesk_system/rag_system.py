...
# .parent es la carpeta donde estás, el segundo .parent es la de arriba
...
class VectorRAGSystem:
    ...
    def __init__(self, chroma_path: str = "./chroma_db"):
        ...
        self.llm = LocalGemma4(model_path=LLM_MODEL_PATH, temperature=0)
...
if __name__ == "__main__":    
    rag_system = VectorRAGSystem(chroma_path=CHROMADB_PATH)
    
    # 2. Definir la pregunta de prueba
    pregunta_prueba = "Tengo un error 500"
    
    print(f"\n🔍 Procesando consulta: '{pregunta_prueba}'")
    print("-" * 50)
    
    # 3. Ejecutar la búsqueda
    resultado = rag_system.buscar(pregunta_prueba)
    ...
    print(f"   • Fuentes consultadas: {', '.join(resultado['fuentes']) if resultado['fuentes'] else 'Ninguna'}")
