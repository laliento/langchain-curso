## No funciona por no tener las credenciales de google
...
os.chdir(r"C:\Users\laptop\git\langchain-curso\agentes_pruebas")
...
def create_gmail_reply_draft(message: str, to: str, subject: str, thread_id: str, in_reply_to: str = None) -> str:
    ...
    try:
        try:
            ...
            # A veces el error es porque falta el tipo 'Resource', lo importamos preventivamente
            from googleapiclient.discovery import Resource
            GmailToolkit.model_rebuild()
